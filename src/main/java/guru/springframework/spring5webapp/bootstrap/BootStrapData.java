...
public class BootStrapData implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		publisher.setAddressLine1("0000 Address Dr");
		publisher.setCity("miami");
		publisher.setState("florida");
		publisher.setZip("32304");
...
//		System.out.println("Publisher Number of books: " + publisherRepository.findById(publisher.getId()).get().getBooks());
